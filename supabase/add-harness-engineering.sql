-- Insert Harness Engineering article
INSERT INTO public.posts (slug, title, excerpt, content, tags, published, published_at) VALUES
  ('harness-engineering', 'Harness Engineering（驾驭工程）',
   'AI 模型已经能写出 100 万行代码。真正的挑战不再是让它写得更好，而是怎么驾驭它稳定、可靠、不失控地工作。这套围绕 AI 智能体构建约束、反馈与控制系统的方法论，就是 2026 年初迅速席卷工程圈的新范式——Harness Engineering。',
...
- **100万** — OpenAI 团队 5 个月产出代码行数
- **0行** — 工程师手动编写的代码
- **3~7人** — 团队规模，人均每日 3.5 个 PR
- **30 → 5** — LangChain 仅改 Harness，Terminal Bench 排名跃升
...
工程师的价值正在从执行者转变为赋能者和系统思考者 —— 从构建产品转向构建能够构建产品的工厂。',
   ARRAY['ai', 'engineering', 'agent', 'clippings'],
   true, '2026-04-21T10:00:00Z')
